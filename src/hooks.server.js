...
export async function handle({ event, resolve }) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://*.convex.cloud https://*.convex.site wss://*.convex.cloud wss://*.convex.site", // Convex connections
  ...
  response.headers.set("Cross-Origin-Embedder-Policy", "require-corp"); // Enhanced isolation
