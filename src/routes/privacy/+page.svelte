      ...
      <div class="prose prose-lg max-w-none">
        ...
        <div class="mb-8 rounded-xl border border-blue-200 bg-blue-50 p-6">
          <p class="text-blue-800">
            ...
            how Room Dates ("we," "our," or "us") collects, uses, and protects your
        ...
        <ul class="mb-6 list-inside list-disc space-y-2 text-gray-700">
          <li>
            <strong>With other users:</strong> Profile information is visible to
            facilitate connections
          </li>
          <li>
            <strong>Service providers:</strong> Trusted third parties who help us
        ...
        <p class="mb-6 text-gray-700">
          ...
          legitimate business purposes or legal requirements after account
          deletion.
        </p>
